...
Phương thức `directories` trả về một mảng gồm tất cả các thư mục có trong một thư mục đã cho. Nếu bạn muốn lấy ra một danh sách tất cả các thư mục có trong một thư mục nhất định bao gồm cả các thư mục con, bạn có thể sử dụng phương thức `allDirectories`:
