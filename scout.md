...
Scout cho phép bạn thêm các câu lệnh "where" đơn giản vào các truy vấn tìm kiếm của bạn. Hiện tại, các câu lệnh này chỉ hỗ trợ các kiểm tra cơ bản và chủ yếu hữu ích cho việc thu hẹp phạm vi của các truy vấn tìm kiếm theo một owner ID:
